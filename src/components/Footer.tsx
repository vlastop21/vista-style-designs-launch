        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-vista-blue hover:text-vista-lightblue">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-600 hover:text-vista-blue transition-colors">About Us</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">123 Business Ave, Suite 200<br />Cityville, ST 12345</span>
              </li>
